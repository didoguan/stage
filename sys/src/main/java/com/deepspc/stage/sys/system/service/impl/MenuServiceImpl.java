...
import com.deepspc.stage.sys.system.mapper.MenuMapper;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements IMenuService {
    ...
    public void saveUpdateMenu(MenuDto menuDto) {
        ...
        if (null != menu && null != menuDto.getMenuId() && menu.getMenuId().longValue() != menuDto.getMenuId().longValue()) {
            throw new StageException(SysExceptionCode.MENU_CODE_EXISTS.getCode(),
                    SysExceptionCode.MENU_CODE_EXISTS.getMessage());
        }
    ...
    private Menu exchangeMenu(MenuDto menuDto) {
        ...
        if (null == pid || pid.longValue() == 0) {
            ...
            if (parent.getCode().equals(menu.getCode())) {
                throw new StageException(SysExceptionCode.MENU_CODE_PCODE_MATCH.getCode(),
                        SysExceptionCode.MENU_CODE_PCODE_MATCH.getMessage());
            }
