...
import com.deepspc.stage.sys.system.entity.RolePermission;
import com.deepspc.stage.sys.system.entity.UserAccess;
import com.deepspc.stage.sys.system.mapper.RoleMapper;
import com.deepspc.stage.sys.system.mapper.RolePermissionMapper;
...
public class RoleServiceImpl extends BaseOrmService<RoleMapper, Role> implements IRoleService {
    ...
    public void saveUpdateRole(Role role) {
        ...
        if (null != exists && null != roleId && roleId.longValue() != exists.getRoleId().longValue()) {
            throw new StageException(SysExceptionCode.ROLE_CODE_EXISTS.getCode(),
                    SysExceptionCode.ROLE_CODE_EXISTS.getMessage());
        }
        if (null == roleId) {
